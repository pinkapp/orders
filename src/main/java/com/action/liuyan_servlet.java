...
public class liuyan_servlet extends HttpServlet
{
	...
	public void liuyanAdd(HttpServletRequest req,HttpServletResponse res)
	{
		...
		req.setAttribute("path", "liuyan?type=liuyanAll1");
	...
	public void liuyanAll(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
	{
		...
		String sql="select * from t_liuyan order by shijian desc  ";
		Object[] params={};
		DB mydb=new DB();
		try
		{
	...
	public void liuyanAll1(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
	{
		List liuyanList=new ArrayList();
		String sql="select * from t_liuyan order by shijian desc";
		Object[] params={};
		...
		req.setAttribute("liuyanList", liuyanList);
		req.getRequestDispatcher("qiantai/liuyan/liuyanAll1.jsp").forward(req, res);
	}
